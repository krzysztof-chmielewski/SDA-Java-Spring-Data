package com.kchmielewski.sda.java.spring05java.data.player.web;

import com.kchmielewski.sda.java.spring05java.data.player.model.Player;
import com.kchmielewski.sda.java.spring05java.data.player.service.PlayerService;
...
public class PlayerController {
    ...
    public String findBySurnameStartingWith(@PathVariable String surname, Model model) {
        model.addAttribute("players", playerService.findBySurnameStartingWith(surname));

        return "players";
    }

    @GetMapping("lallana")
    public String findLallana(Model model) {
        model.addAttribute("players", playerService.findLallana());
